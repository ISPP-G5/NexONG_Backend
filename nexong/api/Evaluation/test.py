...
class EducatorEvaluationTypeTestCase(APITestCase):
    def setUp(self):
        ...
        self.educator = Educator.objects.create(description="Profesor de lengua", birthdate="1969-04-21")
        self.educator2 = Educator.objects.create(description="Profesor de mates", birthdate="1998-04-21")
    ...
    def test_obtain_evaluation_type_by_educator(self):
        ...
        eval_type_forbid = EvaluationType.objects.create(**self.evaluation_type_data_forbiden)
...
class EducatorStudentEvaluationTestCase(APITestCase):
    ...
    def test_obtain_student_evaluation_by_educator(self):
        ...
        student_eval_forbid = StudentEvaluation.objects.create(**self.student_eval_data_forbiden)
        response = self.client.get(
    ...
    def test_update_student_evaluation_by_educator(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(StudentEvaluation.objects.get().comment, "Mejoro tras la revision")
