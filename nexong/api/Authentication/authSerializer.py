...
class UserSerializer(ModelSerializer):
    ...
    def validate(self, data):
        ...
        if data["role"]=="EDUCATOR" and data["educator"] is None:
             validation_error[
                    "educator"
                ] = "Given role \"EDUCATOR\", this cannot be null."
             ...
             validation_error[
                    "family"
                ] = "Given role \"FAMILY\", this cannot be null."
        elif data["role"]=="PARTNER" and data["partner"] is None:
             validation_error[
                    "partner"
                ] = "Given role \"PARTNER\", this cannot be null."
        elif data["role"]=="VOLUNTEER_PARTNER" and (data["volunteer"] is None or data["partner"] is None):
             validation_error[
                    "volunteer"
                ] = "Given role \"VOLUNTEER\", this cannot be null."
             validation_error[
